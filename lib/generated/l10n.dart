...
class S {
  ...
  /// `The order delivered successfully to client`
  String get theOrderDeliveredSuccessfullyToClient {
    return Intl.message(
      'The order delivered successfully to client',
      name: 'theOrderDeliveredSuccessfullyToClient',
      desc: '',
      args: [],
    );
  }
